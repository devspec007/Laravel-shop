...
<div class="page-wrapper">
    <div class="content">
        @component('components.pageheader')                
			...
			@slot('title_1') Create new  Expenses Category @endslot
		@endcomponent
        <!-- /add -->
        <form action="{{route('admin.expense-category.store')}}" method="post" class="submit-form" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row">
