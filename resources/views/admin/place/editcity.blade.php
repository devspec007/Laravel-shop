...
<div class="page-wrapper">
    <div class="content">
		...
		@endcomponent
        <!-- /add -->
        <form action="{{route('admin.city.update',[$place->id])}}" method="post" class="submit-form" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="select" name="state">
                                    ...
                                    @foreach ($states as $state)
                                        <option value="{{$state->id}}" {{$place->p_id == $state->id ? 'selected' : ''}}>{{$state->name}}</option>
                                    @endforeach
                                </select>
