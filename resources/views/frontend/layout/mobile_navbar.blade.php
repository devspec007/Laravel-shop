    ...
    <div class="mobile-header-wrapper-inner">
        ...
        <div class="mobile-header-content-area">
            ...
            <div class="mobile-menu-wrap mobile-header-border">
                {{-- <div class="main-categori-wrap mobile-header-border">
                    ...
                    <div class="categori-dropdown-wrap categori-dropdown-active-small">
                        <ul>
                            ...
                            <li><a href="{{route('frontend.shop',[$data->slug])}}"><i class="evara-font-dress"></i>{{$data->name}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div> --}}
                <!-- mobile menu start -->
                <nav>
                    {!! CollapseAbleMobileMenu('header')!!}
                    {{-- <ul class="mobile-menu">
                        <li class="menu-item-has-children"><span class="menu-expand"></span><a href="{{route('frontend.home')}}">Home</a>
                            <ul class="dropdown">
                        ...
                        <li class="menu-item-has-children"><span class="menu-expand"></span><a href="shop-grid-right.html">shop</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="{{route('frontend.cart')}}">Shop – Cart</a></li>
