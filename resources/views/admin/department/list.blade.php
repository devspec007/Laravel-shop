                ...
                <div class="table-top">
                    ...
                    <div class="wordset">
                        <ul>
                            ...
                            <li>
                                <a class="btn btn-sm btn-primary" href="{{route('admin.department.create')}}">Add</a>
                            </li>
                            @endif
                            {{-- <li>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th>Name</th>
                                <th>Status</th>
                                @if (auth()->user()->can('department-delete') || auth()->user()->can('department-edit'))
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="me-3" href="{{route('admin.department.edit',[$data->id])}}">
                                        <img src="{{ URL::asset('/assets/img/icons/edit.svg')}}" alt="img">
                                    </a>
                                    @endif
                                    @if (auth()->user()->can('department-delete'))

                                    <a class="me-3 confirm-text delete-btn" data-href="{{route('admin.department.delete',[$data->id])}}">
