<?php $page="temporderlist";?>
@extends('layout.mainlayout')
@section('content')
<div class="page-wrapper">
    <div class="content">
        @component('components.pageheader')                
			@slot('title') Temp Order List @endslot
			@slot('title_1') Manage Temp Order @endslot
		@endcomponent
        <!-- /product list -->
        <div class="card">
            <div class="card-body">
                <div class="table-top">
                    ...
                    <div class="wordset">
                         <ul>
                            <li>
                                <a href="{{route('admin.temp-orders.create')}}" class="btn btn-sm btn-primary">Create Order</a>
                            </li>
                           {{--
                              <li>
