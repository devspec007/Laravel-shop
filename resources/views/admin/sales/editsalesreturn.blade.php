...
<div class="page-wrapper">
    <div class="content">
        ...
        <form action="{{route('admin.sales.return.update-item',[$item->id])}}" class="submit-form" method="post">
            @csrf
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-sm-10 col-10">
                                        <input class="form-control" disabled value="{{$item->orderItem->order->order_number}}">
                                    </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-sm-10 col-10">
                                        <input class="form-control" disabled value="{{$item->orderItem->order->customer_name}}">
                                    </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-sm-10 col-10">
                                        <input class="form-control" disabled value="{{$item->orderItem->order->customer_mobile}}">
                                    </div>
                        ...
                        <div class="col-lg-12 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-groupicon">
                                    <input type="text" disabled value="{{$item->orderItem->description}}">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-sm-10 col-10">
                                        <input class="form-control" disabled value="{{$item->orderItem->amount}}">
                                    </div>
