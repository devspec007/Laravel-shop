...
<div class="page-wrapper">
    <div class="content">
        @component('components.pageheader')                
			@slot('title') Role ADD @endslot
			@slot('title_1') Create new Role @endslot
		@endcomponent
        <!-- /add -->
        <form action="{{route('admin.role.store')}}" method="post" class="submit-form" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row">
