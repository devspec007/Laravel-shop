                        ...
                        <div class="tab-content dashboard-content">
                            ...
                            <div class="tab-pane fade active show" id="address" role="tabpanel" aria-labelledby="address-tab">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="{{route('frontend.customer.address.update',[$address->id])}}" class="login-form">
                                            @csrf
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <label>Name <span class="required">*</span></label>
                                                    <input class="form-control square" name="name" type="text" value="{{$address->name}}">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input class="form-control square" name="phone_no" type="text" value="{{$address->phone_no}}">
                                                ...
                                                <div class="col-lg-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control square state-city-list" name="city">
                                                            ...
                                                            @if ($address->state)
                                                            @foreach ($address->state->child as $city)
                                                ...
                                                <div class="col-lg-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label>Pincode</label>
                                                        <input type="text" class="form-control square" name="pincode" value="{{$address->pincode}}">
                                                ...
                                                <div class="col-lg-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label>Area</label>
                                                        <input type="text" class="form-control square" name="area" value="{{$address->area}}">
                                                ...
                                                <div class="col-lg-12 col-12">
                                                    <div class="form-group">
                                                        <label>Address</label>
                                                        <input type="text" class="form-control square" name="address" value="{{$address->address}}">
